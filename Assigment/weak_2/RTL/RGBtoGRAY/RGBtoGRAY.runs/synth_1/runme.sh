...
HD_PWD='/home/theanhnp/RGBtoGRAY/RGBtoGRAY.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log int_to_float.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source int_to_float.tcl
